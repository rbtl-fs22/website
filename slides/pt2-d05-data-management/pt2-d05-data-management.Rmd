...
.big[Data Organisation in Spreadsheets]
...
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/UEGwYCVTBFa9tJEf66" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/rainbow-computer-data-UEGwYCVTBFa9tJEf66">via GIPHY</a></p>

---
## Why? 

**Because I will make your life easier!**

```{r}
knitr::include_graphics("img/data-org-views.png")
```

.footnote[[Screenshot taken on 2022-03-23](https://www.tandfonline.com/toc/utas20/current#b7689c1d-7975-46ed-aaf9-3a2939834054-b6de7b7c-de82-45a5-9538-313dd15c6659)]
...
1. Groups will program their revised questionnaire onto a digital platform so it is ready to use for the following class

2. Groups will transfer their variables into a spreadsheet database

3. Groups will write a codebook for their spreadsheet database

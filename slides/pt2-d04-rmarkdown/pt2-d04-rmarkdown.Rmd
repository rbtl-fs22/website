...
---
# Homework Assignment 4 - Group submission

- Assignment 4 - due on **22nd March**

## Each group will

1. Identify the variables that are needed
2. Develop the necessary questions and response values
3. Submit the compiled questions as a markdown file (1 submission per group) on GitHub before 2022-03-22 23:59

...
1. Install Zotero Connector for the Firefox browser
2. Install Better BibTeX for Zotero Add-on
3. Edit the Zotero CiteKey preferences to the following (Minute **XX:XX**):
...
The following links are used in the video:

- https://www.zotero.org/  
- https://retorque.re/zotero-better-bibtex/installation/  
- https://www.tandfonline.com/doi/full/10.1080/00031305.2017.1375989  

# Video (posted on 2022-03-10)
